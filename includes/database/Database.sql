...
CREATE TABLE `ingresos` (
  ...
  `ingresos` decimal(5,2) DEFAULT NULL,
...
CREATE TABLE `proyectos` (
  ...
  `nombre_proyecto` varchar(60) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `descripcion` longtext COLLATE utf8mb4_unicode_ci,
  `portada` varchar(200) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `img_descripcion` varchar(200) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
-- Dump completed on 2023-11-09  2:20:38
